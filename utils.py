...
def back_admin_keyboard():
    return InlineKeyboardMarkup([[InlineKeyboardButton("⬅️ Retour panel admin", callback_data="admin:home")]])
...
def broadcast_menu_keyboard():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🎨 Créateurs", callback_data="broadcast:target:creator")],
        [InlineKeyboardButton("💳 Acheté légalement", callback_data="broadcast:target:bought")],
        [InlineKeyboardButton("🔐 Accès privé", callback_data="broadcast:target:private_access")],
